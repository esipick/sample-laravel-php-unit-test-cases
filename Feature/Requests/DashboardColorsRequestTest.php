...
use App\Http\Requests\DashboardColorsRequest;
...
class DashboardColorsRequestTest extends TestCase
{
    public function testAuthorizeReturnsTrueWhenUserIsAuthenticated()
    {
        Auth::shouldReceive('check')->once()->andReturn(true);

        $request = new DashboardColorsRequest();
    ...
    public function testRulesValidationPassesWithValidData()
    {
        ...
        $validator = Validator::make($validData, (new DashboardColorsRequest())->rules());
    ...
    public function testRulesValidationFailsWithInvalidData()
    {
        ...
        $validator = Validator::make($invalidData, (new DashboardColorsRequest())->rules());
