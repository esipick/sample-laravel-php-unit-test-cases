...
use App\Http\Requests\GetProfilesRequest;
...
class GetProfilesRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function testAuthorizeReturnsFalseWhenUserIsNotAuthorized()
    {
        ...
        $request = new GetProfilesRequest(['locationID' => $location->locationID]);
    ...
    public function testRulesValidationPassesWithValidData()
    {
        ...
        $validData = [
            'search' => 'example',
            'hasGlobalRoles' => true,
            'onlyLocationUserGlobalRoles' => false,
            'perPage' => 10,
            'orderBy' => 'asc',
            'orderByField' => 'profileID',
            'page' => 1,
            'locationID' => $location->locationID,
        ];

        $validator = Validator::make($validData, (new GetProfilesRequest())->rules());
    ...
    public function testRulesValidationFailsWithInvalidData()
    {
        $invalidData = [
            'search' => 123,
            'hasGlobalRoles' => 'not_a_boolean',
            'onlyLocationUserGlobalRoles' => 'not_a_boolean',
        ...
        $validator = Validator::make($invalidData, (new GetProfilesRequest())->rules());
